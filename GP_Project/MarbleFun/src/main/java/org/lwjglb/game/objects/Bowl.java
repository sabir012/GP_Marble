...
public class Bowl extends GameItem {
	...
	public Bowl(Mesh mesh, float xstart, float ystart, float xend, float yend, PhysicalMaterial material) throws Exception {
		super(mesh);
	...
	public Bowl(Mesh mesh, PhysicalMaterial material) {
		super(mesh);
